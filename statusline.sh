...
if [ -n "$RTK_SAVED" ] && [ -n "$RTK_PCT" ]; then
    METRICS="${METRICS}$(printf ' \033[90m|\033[0m 💾 \033[32m%s (%s)\033[0m \033[90m(rtk gain)\033[0m' "$RTK_SAVED" "$RTK_PCT")"
else
    METRICS="${METRICS}$(printf ' \033[90m|\033[0m 💾 \033[90m0 (rtk gain)\033[0m')"
fi
